...
THIRD_FOURSQUARE_CLIENT_ID = os.getenv('THIRD_FOURSQUARE_CLIENT_ID')
THIRD_FOURSQUARE_CLIENT_SECRET = os.getenv('THIRD_FOURSQUARE_SECRET')
FOURTH_FOURSQUARE_CLIENT_ID = os.getenv('FOURTH_FOURSQUARE_CLIENT_ID')
FOURTH_FOURSQUARE_CLIENT_SECRET = os.getenv('FOURTH_FOURSQUARE_SECRET')
FIFTH_FOURSQUARE_CLIENT_ID = os.getenv('FIFTH_FOURSQUARE_CLIENT_ID')
FIFTH_FOURSQUARE_CLIENT_SECRET = os.getenv('FIFTH_FOURSQUARE_SECRET')
...
credentials = (
    ...
    fs_credentials(THIRD_FOURSQUARE_CLIENT_ID, THIRD_FOURSQUARE_CLIENT_SECRET),
    fs_credentials(FOURTH_FOURSQUARE_CLIENT_ID, FOURTH_FOURSQUARE_CLIENT_SECRET),
    fs_credentials(FIFTH_FOURSQUARE_CLIENT_ID, FIFTH_FOURSQUARE_CLIENT_SECRET)
)
